    ...
    <div className="h-screen overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] h-screen">
        ...
        <main className="h-screen lg:border-x border-border overflow-y-auto scrollbar-hide bg-background">
          ...
          <Suspense fallback={<ChallengesContentSkeleton isAdmin={isAdmin} />}>
            <ChallengesContent
              isAdmin={isAdmin}
              chainId={chainId}
              showCreateChallengeSheet={showCreateChallengeSheet}
              onShowCreateChallengeSheet={setShowCreateChallengeSheet}
...
function ChallengesContent({
  isAdmin,
  chainId,
  showCreateChallengeSheet,
  onShowCreateChallengeSheet,
  onChallengeCreated,
}: {
  isAdmin: boolean;
  chainId: number;
  showCreateChallengeSheet: boolean;
  onShowCreateChallengeSheet: (open: boolean) => void;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 lg:py-10 pt-20 lg:pt-6 pb-24 lg:pb-10 text-foreground">
      ...
      <div className="mb-6 md:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        ...
        {isAdmin && (
          <button
            onClick={() => onShowCreateChallengeSheet(true)}
            className={cn(
...
function ChallengesContentSkeleton({ isAdmin }: { isAdmin: boolean }) {
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 lg:py-10 pt-20 lg:pt-6 pb-24 lg:pb-10 text-foreground">
      {/* Header skeleton */}
      <div className="mb-6 md:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div>
          <div className="h-8 w-40 animate-pulse rounded-lg bg-secondary mb-3" />

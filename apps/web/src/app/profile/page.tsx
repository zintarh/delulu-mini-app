...
const recentWinners = [
  {
    creator: "crypto_queen",
    claim: "Made $50k from a meme coin and got my ex back",
    won: 12400,
  },
  {
    creator: "dao_lover",
    claim: "Found my partner through a governance vote",
    won: 8900,
  },
];
            ...
            {isLoading ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  {user.fid && (
                    <p className="text-xs text-white/40 mt-1">FID: {user.fid}</p>
                  )}
                </div>
              </div>
            ) : (
        ...
        {/* <div>
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 -mx-4 px-4">
            {recentWinners.map((winner, i) => (
              <div
                key={i}
                className="shrink-0 bg-[#1a1a1a] rounded-2xl p-3 w-40"
              >
                ...
                <p className="text-sm font-black text-delulu-yellow">
                  +${winner.won}
                </p>
              </div>
            ))}

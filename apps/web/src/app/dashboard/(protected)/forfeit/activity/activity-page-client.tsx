    ...
    <DashboardPage className="max-w-none px-5 sm:px-7">
      ...
      <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {data && data.pool.length > 0 ? (
          ...
          <div className="col-span-full flex items-center gap-2 rounded-2xl border border-border bg-card px-4 py-4 text-sm text-muted-foreground shadow-sm">
            ...
            <div className="flex items-center justify-between border-t border-border px-5 py-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-bold text-foreground disabled:opacity-40 hover:bg-muted transition-colors"
                >
                  Previous
                </button>
                <button

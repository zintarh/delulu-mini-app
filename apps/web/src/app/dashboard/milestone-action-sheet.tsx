...
import { DASHBOARD_MODAL_CONTENT_CLASS } from "@/components/dashboard/dashboard-ui";
...
export function MilestoneActionSheet({
  ...
  return (
    <ResponsiveSheet
      ...
      modalClassName={DASHBOARD_MODAL_CONTENT_CLASS}
    >
      <div className="mx-auto max-w-2xl space-y-5 px-6 pb-8 pt-6 text-foreground">
        ...
        {isSuccess && (
          <p className="text-sm text-delulu-blue font-medium text-center">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            ...
            className={cn(
              "flex-1 py-3 rounded-lg text-sm font-bold flex items-center justify-center gap-2 border border-border transition-all active:scale-[0.98]",
              mode === "reject"
                ? "bg-destructive text-destructive-foreground hover:bg-destructive/90"
                : "bg-delulu-blue text-white hover:bg-delulu-blue/90"
            )}
          >
            {busy ? (
              <>

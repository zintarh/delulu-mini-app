      ...
      <main className="h-screen overflow-y-auto scrollbar-hide bg-background">
          <div className="max-w-3xl mx-auto px-4 py-6 lg:py-10 pb-24 lg:pb-10">
            <div className="flex items-center justify-between mb-6">
              <button
                ...
                className={cn(
                  ...
                  "bg-delulu-yellow-reserved shadow-[2px_2px_0px_0px_#1a1a19]",
                  "hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_#1a1a19]",
            ...
            <div className="space-y-4">
              <section className="rounded-3xl border-2 border-border bg-gradient-to-br from-delulu-yellow-reserved/80 via-card to-card p-4 mb-6 lg:p-6 shadow-[4px_4px_0px_0px_#1a1a19]">
                ...
                {!authenticated ? (
                  <button
                    ...
                    className={cn(
                      ...
                      "shadow-[3px_3px_0px_0px_#1a1a19]",
                  ...
                  <div className="space-y-4">
                    {entitlement !== null && entitlement > 0n && (
                      <div className="rounded-xl border border-border bg-card p-3 flex items-center justify-between">
                        ...
                        {!hasClaimed && (
                          <span className="inline-flex items-center gap-1 text-[11px] font-medium text-emerald-600 bg-emerald-500/10 px-2 py-1 rounded-full">

...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 z-[100] rounded-full w-8 h-8 flex items-center justify-center bg-gray-900 hover:bg-gray-800 text-white transition-colors">
        <X className="h-4 w-4" />

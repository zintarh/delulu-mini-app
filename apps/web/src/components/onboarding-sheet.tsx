    ...
    body: (
      <>
        ...
        <p className="text-[11px] text-muted-foreground">
          ...
          <span className="font-semibold">claim your daily UBI</span> on the{" "}
          <span className="font-semibold text-delulu-yellow-reserved">Claim</span> page.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        <p className="text-xs text-muted-foreground mb-2">
          ...
          <span className="font-semibold text-delulu-yellow-reserved">Create</span> to launch.
        </p>
        <p className="text-[11px] text-muted-foreground">
    ...
    >
      <div className="flex flex-col h-full bg-[radial-gradient(circle_at_top,_rgba(250,204,21,0.10),_transparent_60%),radial-gradient(circle_at_bottom,_rgba(59,130,246,0.10),_transparent_55%)]">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-4">
          <div className="inline-flex items-center rounded-full bg-delulu-yellow-reserved/10 border border-delulu-yellow-reserved/40 px-3 py-1 mb-2">
            <span className="text-[11px] font-semibold text-delulu-yellow-reserved">
              {step.title}
            </span>
          </div>
        ...
        <div className="px-6 py-4 border-t border-border/70 flex items-center justify-between gap-3 bg-secondary/95">
          <button
            ...
            className={cn(
              "px-3 py-1.5 rounded-full text-[11px] font-semibold border border-border text-muted-foreground",
          ...
          <div className="flex items-center gap-2">
            ...
            {isLast && (
              <button
                ...
                className={cn(
                  "px-5 py-2 rounded-full text-[11px] font-black",

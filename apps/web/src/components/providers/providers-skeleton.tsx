...
import { HomeGuestSkeleton } from "@/components/delulu-skeleton";

export type ProvidersSkeletonVariant = "default" | "home-guest";
...
export function ProvidersSkeleton({
  ...
  variant?: ProvidersSkeletonVariant;
}) {
  return (
    <div className="flex h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 flex-col lg:pl-24">
        ...
        {variant === "home-guest" ? (
          <div className="flex flex-1 flex-col pb-24 pt-[4.5rem] lg:pb-12 lg:pt-6">
            <HomeGuestSkeleton />
          </div>
        ) : (

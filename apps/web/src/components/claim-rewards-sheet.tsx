        ...
        <div className="max-w-lg mx-auto px-6 pb-8">
          ...
          <div className="mb-6">
            <div className="bg-muted/30 rounded-2xl p-6 border border-border">
              <p className="text-xs text-muted-foreground mb-2 text-center">Total Rewards</p>
              <p className="text-3xl font-black text-foreground text-center">
                {isLoadingStats ? "..." : `$${(totalClaimed ?? 0).toFixed(2)}`}
              </p>
              <p className="text-xs text-muted-foreground/60 mt-2 text-center">Available to claim</p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3 font-bold text-sm rounded-xl bg-delulu-yellow text-delulu-charcoal hover:brightness-105 active:scale-[0.99] transition-all"
          >
            Claim Rewards
          </button>
      </div>

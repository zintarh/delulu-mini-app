...
// ---------------------------------------------------------------------------
// Hand-added below: `npm run codegen` currently fails against the live
// deployed subgraph schema for an unrelated pre-existing reason (delulus.graphql
// queries `finisherWindowEnd`, which isn't deployed yet). These blocks were
// captured from a one-off successful codegen run (with that field temporarily
// stripped) so GetForfeitActivityByUser stays typed in the meantime. Safe to
// delete once a full `npm run codegen` run succeeds again — the same names
// will be regenerated identically from forfeit-activity.graphql.
// ---------------------------------------------------------------------------

export type ForfeitPeriodResolution_OrderBy =
  | 'amountToDestination'
  | 'bountyPaid'
  | 'commitment'
  | 'commitmentId'
  | 'commitment__active'
  | 'commitment__cadence'
  | 'commitment__cancelled'
  | 'commitment__commitmentId'
  | 'commitment__createdAt'
  | 'commitment__creatorAddress'
  | 'commitment__currentPeriodDeadline'
  | 'commitment__currentPeriodIndex'
  | 'commitment__destinationAddr'
  | 'commitment__destinationType'
  | 'commitment__hasPendingVerifierInvite'
  | 'commitment__id'
  | 'commitment__periodSeconds'
  | 'commitment__stakeAmount'
  | 'commitment__token'
  | 'commitment__totalPeriods'
  | 'commitment__verifier'
  | 'createdAt'
  | 'creatorAddress'
  | 'destinationAddr'
  | 'destinationType'
...
export type GetForfeitActivityByUserQueryVariables = Exact<{
  address: Scalars['String']['input'];
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<ForfeitPeriodResolution_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
}>;


export type GetForfeitActivityByUserQuery = { forfeitPeriodResolutions: Array<{ id: string, commitmentId: string, periodIndex: number, outcome: string, amountToDestination?: string | null, destinationType?: number | null, destinationAddr?: string | null, platformFee?: string | null, bountyPaid?: string | null, txHash: string, createdAt: string, commitment: { token: string, active: boolean, stakeAmount: string } }> };

export const GetForfeitActivityByUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetForfeitActivityByUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"address"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"100"}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"orderBy"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ForfeitPeriodResolution_orderBy"}},"defaultValue":{"kind":"EnumValue","value":"createdAt"}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"orderDirection"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OrderDirection"}},"defaultValue":{"kind":"EnumValue","value":"desc"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"forfeitPeriodResolutions"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"orderBy"}}},{"kind":"Argument","name":{"kind":"Name","value":"orderDirection"},"value":{"kind":"Variable","name":{"kind":"Name","value":"orderDirection"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"creatorAddress"},"value":{"kind":"Variable","name":{"kind":"Name","value":"address"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"commitmentId"}},{"kind":"Field","name":{"kind":"Name","value":"periodIndex"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"amountToDestination"}},{"kind":"Field","name":{"kind":"Name","value":"destinationType"}},{"kind":"Field","name":{"kind":"Name","value":"destinationAddr"}},{"kind":"Field","name":{"kind":"Name","value":"platformFee"}},{"kind":"Field","name":{"kind":"Name","value":"bountyPaid"}},{"kind":"Field","name":{"kind":"Name","value":"txHash"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"commitment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"token"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"stakeAmount"}}]}}]}}]}}]} as unknown as DocumentNode<GetForfeitActivityByUserQuery, GetForfeitActivityByUserQueryVariables>;

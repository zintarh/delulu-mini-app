# delulu-contract - Smart Contracts

This directory contains the smart contracts for delulu-contract, built with Hardhat and optimized for the Celo blockchain.
